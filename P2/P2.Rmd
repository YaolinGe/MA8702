...
mu = alpha*((s[,1]-0.5)+(s[,2]-0.5))
y = y0 + mu + rnorm(N, mean=0, sd=tau)
...
plot(c(1:No_iter), Likelihood, type="l", col="black", lwd=5, xlab="iteration", ylab="Log likelihood", main="Log likelihood over iteration")

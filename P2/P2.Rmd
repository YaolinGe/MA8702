...
plotf2d <- function(v, string){
  vv <- v
  dim(vv) <- c(n1, n2)
  levelplot(vv, col.regions = coul, main = string, xlab = "s1", ylab = "s2")
}
...
plotf2d(mu_posterior, "Kriging surface")
estd = sqrt(diag(Sigma_posterior))
plotf2d(estd, "Predication standard error")

plotf2d(mu_real, "True field")
```

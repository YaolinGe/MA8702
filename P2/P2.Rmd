...
print(paste("Estimated beta1 is ", round(beta1, digits = 2), "; True beta1 is ", BETA_TRUE[1]))
print(paste("Estimated beta2 is ", round(beta2, digits = 2), "; True beta2 is ", BETA_TRUE[2]))
print(paste("Estimated beta3 is ", round(beta3, digits = 2), "; True beta3 is ", BETA_TRUE[3]))

...
levelplot(t(Sigma)[,seq(from=dim(Sigma)[2],to=1,by=-1)], col.regions = coul, main = "Covariance matrix")
```
### b) 
...
L <- chol(Sigma)
levelplot(t(L)[,seq(from=dim(L)[2],to=1,by=-1)], col.regions = coul, main = "Lower triangular matrix")
